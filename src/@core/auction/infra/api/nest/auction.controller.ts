...
import AuctioneerGuard from '../../../../common/infra/api/nest/guards/auctioneer.guard';
import BidderGuard from '../../../../common/infra/api/nest/guards/bidder.guard';
import { AuctioneerId, BidderId } from '../../../../common/infra/api/nest/guards/user.decorators';
import SystemGuard from '../../../../common/infra/api/nest/guards/system.guard';
